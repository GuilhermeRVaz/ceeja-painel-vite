// ARQUIVO: src/resources/DocumentViewer.tsx
// DESCRIÇÃO: Componente "burro" para exibir a interface de visualização de documentos
// RESPONSABILIDADE: "Interface" - Apenas renderização e interação com o usuário
